                                        ...
                                        <div key={s.id_sala} style={{ background: '#f3f4f6', borderRadius: 16, padding: '1rem', marginBottom: 12, boxShadow: '0 2px 8px rgba(124,58,237,0.06)' }}>
                                            ...
                                            <div style={{ display: 'flex', gap: 8 }}>
                                                ...
                                                {s.creador_id === usuario?.id_usuario && s.codigo_acceso && (
                                                    <button style={{ ...btnStyle, padding: '0.5rem 1.2rem', fontSize: '0.95rem', background: 'linear-gradient(135deg, #f093fb, #7c3aed)' }} onClick={() => copyText(s.codigo_acceso)}>Copiar código</button>
                                                )}
                                            </div>
                                        </div>
                                    ))}
                    ...
                    <div style={{ ...cardStyle, marginTop: 32 }}>
                        ...
                        {selectedSala.creador_id === usuario?.id_usuario && selectedSala.codigo_acceso && (
                            <div style={{ marginTop: 12 }}>
                                ...
                                <button style={{ ...btnStyle, padding: '0.5rem 1.2rem', fontSize: '0.95rem', background: 'linear-gradient(135deg, #f093fb, #7c3aed)', marginLeft: 8 }} onClick={() => copyText(selectedSala.codigo_acceso)}>Copiar código</button>
                            </div>
                        )}
