...
export default function ThemeSelector({ theme, setTheme, compact = false }) {
  ...
  const themes = [
    ...
    /* Eliminado modo 'dark' por petición del cliente: solo queda 'midnight' */
  ...
  return (
    <div ref={menuRef} style={{ position: 'relative' }}>
      <Tooltip content={activeTheme.name === 'midnight' ? 'Tema: Midnight (clic para cambiar)' : 'Tema: Claro (clic para cambiar)'}>
