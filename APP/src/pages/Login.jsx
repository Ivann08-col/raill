    ...
    <div className="page page-auth">
      ...
      <form onSubmit={handle}>
        ...
        <div className="actions">
          <button type="submit" className="btn btn-login-action">Entrar</button>
          <button type="button" className="link" onClick={() => onSwitchMode && onSwitchMode()}>Registrarse</button>
        </div>
      </form>
    </div>
  );
