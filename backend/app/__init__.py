...
# Load environment variables from backend/.env when the app starts.
# This ensures keys like GOOGLE_CLIENT_ID / GOOGLE_CLIENT_SECRET are available
# even if the process wasn't started with those env vars exported.
load_dotenv()
...
from .routes.estado_animo_routes import estado_animo_bp
...
def create_app(config_name='development'):
    ...
    app.register_blueprint(estado_animo_bp)  # url_prefix definido en el blueprint
    # compat route expected by some frontend code
